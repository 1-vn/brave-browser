...
program
  ...
  .option('--onevn_google_api_key <onevn_google_api_key>')
  .option('--onevn_google_api_endpoint <onevn_google_api_endpoint>')
...
program
  ...
  .option('--skip_signing', 'skip signing dmg/onevn_installer.exe')
  .arguments('[build_config]')
  .action(createDist)
...
program
  ...
  .option('--disable_onevn_extension', 'disable loading the Onevn extension')
  .option('--disable_onevn_rewards_extension', 'disable loading the Onevn Rewards extension')
  ...
  .option('--onevn_ads_staging', 'ads staging')
  .option('--onevn_ads_debug', 'ads debug')
  .option('--single_process', 'use a single process')
  .option('--network_log', 'log network activity to network_log.json')
  .option('--output_path [pathname]', 'use the Onevn binary located at [pathname]')
  .arguments('[build_config]')
